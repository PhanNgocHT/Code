...
public class FragmentNgoNghinhTreTho extends Fragment implements ChiTietTinTucMeVaBeAdapter.OnItemClick {
    private static String  TIEU_DE = "Ngộ ngĩnh trẻ thơ";
    private RecyclerView rcvNgoNghinhTreTho;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ngo_nghinh_tre_tho, container, false);
        rcvNgoNghinhTreTho = v.findViewById(R.id.rcvNgoNghinhTreTho);
        rcvNgoNghinhTreTho.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void checkInternet(){
        ...
        if(connectivity.isConnected()){
            ...
            rcvNgoNghinhTreTho.setVisibility(View.VISIBLE);
            layDuLieu();
            ...
            rcvNgoNghinhTreTho.setAdapter(chiTietTinTucMeVaBeAdapter);
        }else {
            rcvNgoNghinhTreTho.setVisibility(View.INVISIBLE);
            lnDisconnectInternet.setVisibility(View.VISIBLE);
        }
    }

    private void layDuLieu() {
        String link = "http://afamily.vn/me-va-be/ngo-nghinh-tre-tho.htm";
    ...
    public void onItemClicked(int position) {
        ...
        intent.putExtra(Constant.keyTieuDeChuyenMuc,"Ngộ nghĩnh trẻ thơ");
