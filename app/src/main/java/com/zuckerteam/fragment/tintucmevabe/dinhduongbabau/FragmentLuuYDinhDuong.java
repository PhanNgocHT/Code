...
public class FragmentLuuYDinhDuong extends Fragment implements ChiTietTinTucMeVaBeAdapter.OnItemClick, ChiTietTinTucMeVaBeAsynTask.GetData {
    private static String TIEU_DE = "Lưu ý dinh dưỡng";
    private RecyclerView rcvLuuYDinhDuong;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_luu_y_dinh_duong, container, false);
        rcvLuuYDinhDuong = v.findViewById(R.id.rcvLuuYDinhDuong);
        rcvLuuYDinhDuong.setLayoutManager(new LinearLayoutManager(getActivity()));
    ...
    private void checkInternet() {
        ...
        if (connectivity.isConnected()) {
            rcvLuuYDinhDuong.setVisibility(View.VISIBLE);
            ...
            rcvLuuYDinhDuong.setAdapter(chiTietTinTucMeVaBeAdapter);
        } else {
            rcvLuuYDinhDuong.setVisibility(View.INVISIBLE);
            lnDisconnectInternet.setVisibility(View.VISIBLE);
        }
    }

    private void layDuLieu() {
        String link = "http://afamily.vn/me-va-be/luu-y-dinh-duong.htm";
    ...
    public void onItemClicked(int position) {
        ...
        intent.putExtra(Constant.keyTieuDeChuyenMuc, "Lưu ý dinh dưỡng");
