...
public class FragmentSaiLamCanTranh extends Fragment implements ChiTietTinTucMeVaBeAdapter.OnItemClick {
    private static String  TIEU_DE = "Sai lầm cần tránh";
    private RecyclerView rcvSaiLamCanTranh;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_sai_lam_can_tranh, container, false);
        rcvSaiLamCanTranh = v.findViewById(R.id.rcvSaiLamCanTranh);
        rcvSaiLamCanTranh.setLayoutManager(new GridLayoutManager(getActivity(), 1));
    ...
    private void checkInternet(){
        ...
        if(connectivity.isConnected()){
            rcvSaiLamCanTranh.setVisibility(View.VISIBLE);
            ...
            rcvSaiLamCanTranh.setAdapter(chiTietTinTucMeVaBeAdapter);
        }else {
            rcvSaiLamCanTranh.setVisibility(View.INVISIBLE);
    ...
    private void layDuLieu() {
        String link = "http://afamily.vn/me-va-be/nhung-sai-lam-can-tranh.htm";
    ...
    public void onItemClicked(int position) {
        ...
        intent.putExtra(Constant.keyTieuDeChuyenMuc,"Sai lầm cần tránh");
